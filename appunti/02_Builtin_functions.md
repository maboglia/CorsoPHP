...
- [PHP](#php)
        - [Funzioni per array](#funzioni-per-array)
            ...
            - [esempio](#esempio)
            - [bool asort ( array array [, int sort_flags] )](#bool-asort-array-array---int-sort-flags)
            - [bool arsort ( array array [, int sort_flags] )](#bool-arsort-array-array---int-sort-flags)
        ...
        - [FUNZIONI DI DATA E ORA](#funzioni-di-data-e-ora)
            ...
            - [int mktime ( int hour, int minute, int second, int month, int day, int year [, int is_dst])](#int-mktime-int-hour--int-minute--int-second--int-month--int-day--int-year---int-is-dst)
        ...
        - [FUNZIONI PER LA GESTIONE DI FILE E DEL FILESYSTEM](#funzioni-per-la-gestione-di-file-e-del-filesystem)
            ...
            - [bool file_exists ( string filename )](#bool-file-exists-string-filename)
            - [array file ( string filename [, int use_include_path [, resource context]] )](#array-file-string-filename---int-use-include-path---resource-context)
        ...
        - [FUNZIONI MATEMATICHE](#funzioni-matematiche)
            ...
            - [max() restituisce il numericamente più grande dei valori dati come parametro.](#max-restituisce-il-numericamente-pio-grande-dei-valori-dati-come-parametro)
            ...
            - [min() restituisce il numericamente più piccolo dei valori dati come parametro.](#min-restituisce-il-numericamente-pio-piccolo-dei-valori-dati-come-parametro)
        ...
        - [FUNZIONI PER LE STRINGHE](#funzioni-per-le-stringhe)
            ...
            - [mixed str_replace ( mixed search, mixed replace, mixed subject [, int &count] )](#mixed-str-replace-mixed-search--mixed-replace--mixed-subject---int-count)
        ...
        - [FUNZIONI DI VARIABILI](#funzioni-di-variabili)
            ...
            - [bool is_array ( mixed var )](#bool-is-array-mixed-var)
